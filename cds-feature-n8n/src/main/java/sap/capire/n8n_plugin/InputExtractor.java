...
class InputExtractor {
    ...
    private static String resolvePath(Object value) {
        ...
        if (value instanceof Map<?, ?> m && m.containsKey("=")) return (String) m.get("=");
        return null;
    }
    ...
    // Returns the last segment of a dot-separated path as the default map key (e.g. "items.price" → "price").
    ...
    private static Object getNestedValue(String path, Map<String, Object> data) {
        ...
        return nested instanceof Map ? getNestedValue(path.substring(dot + 1), (Map<String, Object>) nested) : null;
    }
}
