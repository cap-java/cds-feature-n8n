...
// ServiceDelegator is CAP's base class for custom services; it routes calls through the CAP event bus
// so that @On/@Before/@After handlers can intercept them, rather than executing business logic directly
